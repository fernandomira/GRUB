...
CREATE TABLE `usuarios` (
  ...
  `fksexo` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fksexo` (`fksexo`),
  CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`fksexo`) REFERENCES `sexo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2025-08-09 20:27:56
